...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2026 at 04:21 PM
...
(6, 6, 14, 5, 'nice event haha', '2026-03-27 06:22:37'),
(12, 6, 10, 5, 'zayden damn gay sia', '2026-03-27 14:49:35');
...
(8, 'Voucher', 200, 8, 'recycle bag.jpeg', 'Active');
...
(10, 'WenYong', 'boonyong0410@gmail.com', 'wenyong', '0123456789', '$2y$10$.dMzO1rS6nw3TJG1/bcSluhHvIiNtuVRMD/gUkA9SmFDrTiwEKgOy', 'defaultProfile.png', 'Participant', 295, '', '', '', 'Active', '2026-03-23 01:00:21'),
...
--
ALTER TABLE `pointshistory`
  MODIFY `pointsHistory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
