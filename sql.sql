...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2026 at 10:22 AM
...
(7, 'Test 2', '2026-04-01', '12:00:00', 'APU', 'Clean', 100, 'test', '500kg', '', 'Approved', '2026-03-24 16:53:55', '2026-03-25 17:22:52', 'An approved event was updated by the organizer.', 1, NULL, 13),
...
INSERT INTO `event_gallery` (`gallery_id`, `event_id`, `image_path`, `uploaded_by`, `created_at`, `status`) VALUES
(13, 6, 'uploads/images/1774469665_logo.png', 10, '2026-03-25 20:14:25', 'pending');
...
(32, 6, 10, '2026-03-25 16:45:40', 'joined', 'absent');
...
(1, 6, 10, 'uploads/images/1774471274_pingu.jpg', '2026-03-25 20:41:14'),
(2, 6, 10, 'uploads/images/1774471300_logo.png', '2026-03-25 20:41:40'),
(3, 6, 10, 'uploads/images/1774471348_pingu.jpg', '2026-03-25 20:42:28'),
...
INSERT INTO `feedback` (`feedback_id`, `event_id`, `user_id`, `rating`, `feedback_text`, `submitted_at`) VALUES
(2, 7, 1, 5, 'this was a great experience', '2026-03-18 08:40:56'),
(3, 6, 10, 2, 'hiii', '2026-03-26 07:08:57');
...
(8, 10, 'Event Completion: Test 1', 10, '2026-03-25 15:12:07'),
(9, 14, 'Event Completion: Test 1', 10, '2026-03-25 15:12:07'),
(10, 10, 'Event Completion: Test 1', 10, '2026-03-26 00:31:50'),
(11, 10, 'Event Completion Reversed: Test 1', -10, '2026-03-26 00:34:41'),
(12, 10, 'Event Completion: Test 1', 10, '2026-03-26 00:34:48'),
...
(10, 'WenYong', 'boonyong0410@gmail.com', 'wenyong', '0123456789', '$2y$10$.dMzO1rS6nw3TJG1/bcSluhHvIiNtuVRMD/gUkA9SmFDrTiwEKgOy', 'defaultProfile.img', 'Participant', 40, '', '', '', 'Active', '2026-03-23 01:00:21'),
...
(14, 'Zayden', 'Zayden@gmail.com', 'Zayden is Black', '0123456789', '$2y$10$rkeIYRYck9GR4MgfIth2ee/u1rH8H8y2S0xPTxvGAldNdMSyNuvLi', 'defaultProfile.img', 'Participant', 20, '', '', '', 'Active', '2026-03-25 00:58:24'),
...
--
ALTER TABLE `pointshistory`
  MODIFY `pointsHistory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
