...
$sql = "
    SELECT 
        ...
        SUM(CASE WHEN ep.attendance_status = 'present' THEN 1 ELSE 0 END) AS total_present,
        SUM(CASE WHEN ep.attendance_status = 'absent' THEN 1 ELSE 0 END) AS total_absent
    FROM events e
