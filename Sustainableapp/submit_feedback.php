...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $duplicateStmt->bind_param("ii", $event_id, $user_id);
    ...
    $stmt = $conn->prepare("
        INSERT INTO feedback (event_id, user_id, rating, feedback_text)
        VALUES (?, ?, ?, ?)
    ");
    ...
    $stmt->bind_param("iiis", $event_id, $user_id, $rating, $feedback);
