...
try {
    ...
    $notifTitle = "Reward Redeemed Successfully";
    $notifMessage = "You redeemed " . $rewardName . " for " . $pointsCost . " green points.";
    ...
    if (!$notifStmt) {
        throw new Exception("Failed to prepare notification");
    }

    $notifStmt->bind_param("iss", $participant_id, $notifTitle, $notifMessage);
