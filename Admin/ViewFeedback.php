...
<body>
    ...
    <div class = "container">
        ...
        <div class = "firstContent">
            <h1>View Feedback</h1>
            <p>View the user feedback given to events</p>
            <br>
            <table class = "viewFeedbackTable">
                ...
                <?php
                    ...
                    $sql = "SELECT f.feedback_id, f.rating, f.user_email, f.feedback_text, u.user_fullname, e.event_name
                            FROM feedback f
                            JOIN `user` u ON f.user_email = u.user_email
                ...
                <tr>
                    ...
                    <td>
                        <a class="viewButton" href="ViewFeedback2.php?feedback_id=<?php echo $row['feedback_id']; ?>">View</a>
                    </td>
                </tr>
                <?php
                    }
